...
const FreeFireIndonesiaTopUp = () => {
  ...
  const gameId = "68adfc1b384ec2353d40f57c"; // Free Fire Indonesia
  const gameName = "Free Fire (Indonesia)";
  ...
  return (
    <div className="bg-blue-950 min-h-screen text-white p-2 sm:p-4 md:p-6">
      ...
      {/* Game Title Banner */}
      <div className="bg-gradient-to-r from-red-600 to-yellow-600 p-4 rounded-xl mb-6 text-center">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-[#0e08ab] rounded-xl overflow-hidden">
          <img
            src={freeFireBanner}
            alt="Free Fire Indonesia Banner"
        ...
        <div className="bg-[#0e08ab] rounded-xl p-4 sm:p-6 lg:col-span-2 flex flex-col justify-center">
          <h2 className="text-xl font-bold mb-4">Enter your Free Fire ID (Indonesia)</h2>
...
export default FreeFireIndonesiaTopUp;
