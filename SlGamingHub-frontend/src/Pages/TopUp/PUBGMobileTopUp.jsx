...
import { pubgBanner, pubgCard } from "../../utils/imageUtils";

const PUBGMobileTopUp = () => {
  ...
  const gameId = "68adfc5a384ec2353d40f57f"; // PUBG Mobile
  const gameName = "PUBG Mobile (Global)";
  ...
  return (
    <div className="bg-blue-950 min-h-screen text-white p-2 sm:p-4 md:p-6">
      ...
      {/* Game Title Banner */}
      <div className="bg-gradient-to-r from-green-600 to-blue-600 p-4 rounded-xl mb-6 text-center">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-[#0e08ab] rounded-xl p-4 sm:p-6 lg:col-span-2 flex flex-col justify-center">
          <h2 className="text-xl font-bold mb-4">Enter your PUBG Mobile ID</h2>
          <form onSubmit={handleCheckUsername}>
            <input
              id="player-id-input"
              type="text"
              placeholder={isAuthenticated ? "Enter PUBG Mobile ID" : "Login required to use this feature"}
              value={useruid}
            ...
            <button 
              onClick={() => {
                ...
                if (!useruid || useruid.trim() === "") {
                  alert("Please enter your PUBG Mobile ID in the form above!");
...
export default PUBGMobileTopUp;
